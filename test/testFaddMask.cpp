...
TEST(Golden, FaddVV16VFloat16VBVFVFVF_m) {
  MASK_VV_VX_GEN_TEST(OneDBool, OneDFloat16, OneDFloat16,
...
TEST(Golden, FaddVV32VFloat32VBVFVFVF_m) {
  MASK_VV_VX_GEN_TEST(OneDBool, OneDFloat32, OneDFloat32,
...
TEST(Golden, FaddVV64VFloat64VBVFVFVF_m) {
  MASK_VV_VX_GEN_TEST(OneDBool, OneDFloat64, OneDFloat64,
...
TEST(Golden, FaddVF16VFloat16VBVFVFSF_m) {
  MASK_VV_VX_GEN_TEST(OneDBool, OneDFloat16, ScalarFloat16,
...
TEST(Golden, FaddVF32VFloat32VBVFVFSF_m) {
  MASK_VV_VX_GEN_TEST(OneDBool, OneDFloat32, ScalarFloat32,
...
TEST(Golden, FaddVF64VFloat64VBVFVFSF_m) {
  MASK_VV_VX_GEN_TEST(OneDBool, OneDFloat64, ScalarFloat64,
